...
public class FairLocks {
    ...
    public static void main(String[] args) {
        Thread t1 = new Thread(new Main.Worker(ColourConstants.ANSI_RED), "Thread 1");
        Thread t2 = new Thread(new Main.Worker(ColourConstants.ANSI_PURPLE), "Thread 2");
        Thread t3 = new Thread(new Main.Worker(ColourConstants.ANSI_GREEN), "Thread 3");
        Thread t4 = new Thread(new Main.Worker(ColourConstants.ANSI_CYAN), "Thread 4");
        Thread t5 = new Thread(new Main.Worker(ColourConstants.ANSI_BLUE), "Thread 5");
